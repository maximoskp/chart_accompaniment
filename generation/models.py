...
class MelCAT_base(nn.Module):
    def __init__(self, bart_config, gpu=None):
        ...
        self.midi_encoder = RobertaModel.from_pretrained('maximoskp/midi_chart_piano_accompaniment', subfolder='pop_midi_mlm_base/checkpoint-28680').to(self.dev)
        self.midi_rescaler = nn.Linear(512, 256).to(self.dev)
        self.chroma_encoder = RobertaModel.from_pretrained('maximoskp/midi_chart_piano_accompaniment', subfolder='chroma_mlm_tiny/checkpoint-14336').to(self.dev)

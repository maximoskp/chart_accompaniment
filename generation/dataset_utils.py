...
from .midi_pianoroll_utils import midi_pianoroll_utils as mpu
...
remi_path = Path('generation/pop_REMI_BPE_tokenizer.json')
# chroma_tokenizer_path = '/media/datadisk/data/pretrained_models/chroma_mlm_tiny/chroma_wordlevel_tokenizer'
...
class LiveMelCATDataset(Dataset):
    def __init__(self, midis_folder, segment_size=64, resolution=24, max_seq_len=1024, only_beginning=False,\
        ...
        self.roberta_tokenizer_chroma = RobertaTokenizerFast.from_pretrained('maximoskp/midi_chart_piano_accompaniment', subfolder='chroma_mlm_tiny/chroma_wordlevel_tokenizer')
        self.roberta_tokenizer_midi = RobertaTokenizerFast.from_pretrained('maximoskp/midi_chart_piano_accompaniment', subfolder='pop_midi_mlm_base/pop_wordlevel_tokenizer')
